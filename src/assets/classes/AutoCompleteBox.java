...
public class AutoCompleteBox implements EventHandler<KeyEvent> {
    ...
    final private ObservableList<Patients> data;
    private Integer sid;
    ...
    public AutoCompleteBox(final ComboBox comboBox) {
        ...
        this.comboBox.setConverter(new StringConverter<Patients>() {
            @Override
    ...
    private void setConverter() {
        this.comboBox.setCellFactory(cell -> new ListCell<Patients>() {
